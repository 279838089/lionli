(function(){
  const css = `
.theme-warm h1 { font-size: 20px; font-weight: bold; color: #d35400; margin: 16px 0 12px 0; padding: 0; }
.theme-warm h2 { font-size: 18px; font-weight: bold; color: #c0392b; margin: 14px 0 10px 0; padding: 0; border-left: none; }
.theme-warm h3 { font-size: 16px; font-weight: bold; color: #8e44ad; margin: 12px 0 8px 0; padding: 0; border-radius: 0; }
